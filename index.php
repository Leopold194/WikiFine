...
<body>
    ...
    <div class="articleContent">
        ...
        <h2>Lorem Ipsum</h2>
        <p>L'histoire de cette proportion commence à une période de l'Antiquité qui n'est pas connue avec certitude ; la
            première mention connue de la division en extrême et moyenne raison apparaît dans les Éléments d'Euclide. À
            la Renaissance, Luca Pacioli, un moine franciscain italien, la met à l'honneur dans un manuel de
            mathématiques et la surnomme « divine proportion » en l'associant à un idéal envoyé du ciel. Cette vision se
            ...
            Il est érigé en théorie esthétique et justifié par des arguments d'ordre mystique, comme une clé importante,
            voire explicative, dans la compréhension des structures du monde physique, particulièrement pour les
            critères de beauté et surtout d'harmonie ; sa présence est alors revendiquée dans les sciences de la nature
            et de la vie, proportions du corps humain ou dans les arts comme la peinture, l'architecture ou la musique.
